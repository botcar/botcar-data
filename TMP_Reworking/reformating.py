...
for row in label_reader:
	...
	if row[0] != 'labelURN':
		label_type_id = row[0].split('.')[1][:4]
		if label_type_id == 'penL':
			OUT_label_penLabel.write('')
		elif label_type_id == 'penO':
			OUT_label_penOnPage.write('')
		elif label_type_id == 'penc':
			OUT_label_pencilOnPage.write('')
		elif label_type_id == 'type':
			OUT_label_typedLabel.write('')
labelsEdit.close()
